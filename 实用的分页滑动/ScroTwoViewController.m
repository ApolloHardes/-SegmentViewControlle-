...
@interface ScroTwoViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ScroTwoViewController
...
- (void)setupUI
{
    _tableView = [[UITableView alloc]initWithFrame:self.view.bounds style:UITableViewStyleGrouped];
     _tableView.frame= CGRectMake(_tableView.frame.origin.x, _tableView.frame.origin.y, _tableView.frame.size.width, SCREEN_HEIGHT);
